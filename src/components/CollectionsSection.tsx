...
const collections = [
  ...
  // O objeto "Tênis" foi movido para esta posição (3)
  {
    id: 3,
    name: 'Tênis',
    href: '/colecao/tenis',
  ...
  // O objeto "Calças" foi movido para esta posição (5)
  {
    id: 5,
    name: 'Calças',
    href: '/colecao/calcas',
...
const CollectionCard = ({ collection }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-black bg-opacity-20 transition-opacity duration-300 group-hover:bg-opacity-50" />
