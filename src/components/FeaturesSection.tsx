            ...
            return (
              <div
                ...
                className={`
                  ...
                  bg-card-bg/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 shadow-lg
              ...
              >
                ...
                <div>
                  <h4 className="text-base md:text-lg font-bold text-orange-300 mb-1 text-outline-black font-display">
                    {feature.title}
                  </h4>
