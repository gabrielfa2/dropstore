            ...
            return (
              ...
              >
                <div className="flex-shrink-0 mb-4 md:hidden">
                  <IconComponent className="w-10 h-10 text-orange-500 icon-outline-black-300" />
                </div>
                ...
                <div>
                  <h4 className="text-lg font-bold text-orange-500 mb-1 text-outline-black">
                    {feature.title}
                  </h4>
                  <p className="text-white text-sm text-outline-black">
                    {feature.description}
                  </p>
                </div>
              </div>
