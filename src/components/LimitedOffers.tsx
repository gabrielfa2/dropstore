    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {products.map((product) => (
            <div key={product.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="p-6">
                <h4 className="text-xl font-bold text-black mb-3" style={{ fontFamily: "'Permanent Marker', cursive" }}>
                  {product.name}
                </h4>
                <div className="flex items-center gap-3 mb-4">
                  <span className="text-2xl font-black text-orange-500" style={{ fontFamily: "'Permanent Marker', cursive" }}>
                    R$ {product.price.toFixed(2).replace('.', ',')}
                  </span>
                  <span className="text-lg text-gray-400 line-through" style={{ fontFamily: "'Permanent Marker', cursive" }}>
                    R$ {product.originalPrice.toFixed(2).replace('.', ',')}
                  </span>
                </div>
                <button className="w-full bg-gradient-to-r from-orange-400 to-yellow-400 text-black font-bold py-3 rounded-full hover:from-orange-500 hover:to-yellow-500 transition-all duration-300 transform hover:scale-105" style={{ fontFamily: "'Permanent Marker', cursive" }}>
        ...
        <div className="my-16 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8" style={{ fontFamily: "'Permanent Marker', cursive" }}>
        ...
        <div className="text-center mt-12">
          <button className="bg-black text-white px-12 py-4 rounded-full text-xl font-bold hover:bg-gray-800 transform hover:scale-105 transition-all duration-300" style={{ fontFamily: "'Permanent Marker', cursive" }}>
