    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <div className="absolute left-0 top-0 h-full w-5 bg-gradient-to-r from-cream to-transparent z-10"></div>
          <div className="absolute right-0 top-0 h-full w-5 bg-gradient-to-l from-cream to-transparent z-10"></div>
