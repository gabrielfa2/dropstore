    ...
    <section className="pt-6 pb-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mt-12">
           <Link to="/ProductsPage.tsx" className="relative group border-none bg-transparent p-0 outline-none cursor-pointer font-mono font-light uppercase text-base inline-block">
